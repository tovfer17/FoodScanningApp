    ...
    if (!!food) {
      return (
        <View style={{borderColor: '#80808026', borderBottomWidth: 2, paddingBottom: 20, paddingTop: index > 0 ? 20 : 0}}>
          <Text style={{fontSize: 28, fontWeight: 'bold'}}>{food.name} <Button title="Find Locations" color="#007eff" onPress={() => findLocations(food.foodId)}/></Text>
          ...
          <Text style={{fontSize: 20, fontWeight: 'bold', marginBottom: 3, marginTop: 10}}>Ingredients:</Text>
